...
<body>
    ...
    <div id="whoami">
        <h1 id="hi-whoami">Ciao! sono Francesco</h1>
    ...
    <div id="cards">
        <div class="card linux">Linux</div>
        <div class="card apache">Apache</div>
        <div class="card mysql">MySQL</div>
        <div class="card php">PHP</div>
    </div>    
